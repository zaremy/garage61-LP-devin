...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="relative z-10 py-4 px-6 md:px-12 lg:px-24 bg-black/90 text-white">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Button className="bg-[#ff9307] hover:bg-[#ffa32c] text-white font-medium rounded-md">
              Get Started
            </Button>
          </nav>
        </div>
        ...
        {isMenuOpen && (
          <nav className="md:hidden pt-4 pb-2 flex flex-col space-y-4">
            ...
            <a href="#teams" className="hover:text-[#0d6efd] transition-colors">Teams</a>
            <a href="#faq" className="hover:text-[#0d6efd] transition-colors">FAQ</a>
            <Button className="bg-[#ff9307] hover:bg-[#ffa32c] text-white font-medium rounded-md w-full">
              Get Started
            </Button>
          </nav>
        )}
      ...
      <section className="relative h-[600px] flex items-center">
        ...
        <div className="relative z-1 container mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-3xl">
            ...
            <Button className="bg-[#ff9307] hover:bg-[#ffa32c] text-white font-medium rounded-md px-8 py-3 text-lg">
              Start Racing Faster
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-start">
              <div className="bg-[#fff5e0] p-3 rounded-lg mb-4">
                <svg className="w-8 h-8 text-[#ff9307]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
              </div>
            ...
            {/* Feature 2 */}
            <div className="flex flex-col items-start">
              <div className="bg-[#e6f2ff] p-3 rounded-lg mb-4">
                <svg className="w-8 h-8 text-[#0d6efd]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
              </div>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-black text-white">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <Button className="bg-[#ff9307] hover:bg-[#ffa32c] text-white font-medium rounded-md px-8 py-3 text-lg whitespace-nowrap">
              Contact Us
            </Button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-12 px-6 md:px-12 lg:px-24 bg-[#212529] text-white">
        <div className="container mx-auto">
