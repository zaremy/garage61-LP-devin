      ...
      <header className="relative z-10 py-4 px-6 md:px-12 lg:px-24 bg-black/90 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <img src="./assets/image 130.png" alt="Garage61 Logo" className="h-8" />
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 flex justify-between items-center text-gray-500">
            ...
            <div className="flex space-x-4">
              <a href="https://medium.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                <img src="./assets/image 132.png" alt="Medium" className="h-6" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                <img src="./assets/image 130.png" alt="Twitter/X" className="h-6" />
              </a>
            </div>
          </div>
        </div>
