    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] flex items-center">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/30 to-black/70 z-0">
          <img 
            src={process.env.NODE_ENV === 'production' ? '/garage61-LP-devin/assets/header-bg.png' : '/assets/header-bg.png'}
        ...
        <div className="relative z-1 container mx-auto px-6 md:px-12 lg:px-24">
          <div className="max-w-3xl">
            ...
            <Button className="bg-[#0d6efd] hover:bg-[#0b5ed7] text-white font-medium rounded-md px-8 py-3 text-lg">
              Start Racing Faster
            </Button>
          </div>
        </div>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-black text-white">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <Button className="bg-[#0d6efd] hover:bg-[#0b5ed7] text-white font-medium rounded-md px-8 py-3 text-lg whitespace-nowrap">
              Contact Us
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-[#0d6efd] transition-colors">Contact</a></li>
